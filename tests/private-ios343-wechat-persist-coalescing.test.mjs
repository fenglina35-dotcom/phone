...
test('private identity advances to v1229 and iOS 352 while public remains v1229', () => {
  assert.match(privateApp, /__NORTH_SHELL_BUILD__!=='1229'/);
