const BUILD='1164';
const HOTFIX='v1164-scroll-camera-smart-home-hotfix-1';
const SHELL_CACHE='north-shell-v1164-scroll-camera-smart-home-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1164-scroll-camera-smart-home-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1164-scroll-camera-smart-home-1'")
