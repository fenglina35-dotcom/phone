...
test('private release identity is iOS 384 while public web advances independently',()=>{
  ...
  assert.match(project,/CURRENT_PROJECT_VERSION = 384/);
  assert.match(project,/MARKETING_VERSION = 1.0.384/);
  assert.match(read('app.js'),/__NORTH_SHELL_BUILD__!==\'1300\'/);
});
