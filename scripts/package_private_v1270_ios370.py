"""Create the private v1270 / iOS 370 Mac-source overlay package.
...
PREFIX = "SmallPhone_v1270_iOS370_Private/"
OUTPUT = ROOT.parent / "SmallPhone_v1270_iOS370_MacSource.zip"
...
def validate(files: dict[str, bytes]) -> None:
    ...
    for marker, label in [
        ...
        ("sub==='group')return{id:'.dyg-box',stick:true}", "v1270 群聊不再弹回顶部"),
        ("if(!dyGFind(g,m.k))continue;", "v1270 被踢的人不能再说话"),
        ("function dyWorkMusicPlay(id)", "v1270 作品配乐真的能放"),
    ]:
