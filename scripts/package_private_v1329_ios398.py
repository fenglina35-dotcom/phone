"""Create the private v1329 / iOS 398 Mac-source overlay package.
...
PREFIX = "SmallPhone_v1329_iOS398_Private/"
OUTPUT = ROOT.parent / "SmallPhone_v1329_iOS398_MacSource.zip"
...
def main() -> None:
    ...
    files["SOURCE_STATE.json"] = json.dumps({"sourceCommit":text(git("rev-parse","HEAD")).strip(),"upstreamBaseline":"def924d815c0886245803b8d1c632579ed073a91","houseSource":"df56e66a4f24efed42e4c37ef7d1908deb95df03","privateWeb":"v1329","privateIOS":"1.0.398 (398)","bridge":41,"macBuildVerified":False,"realIPhoneVerified":False,"kind":"Mac-source-not-IPA","knownUnresolved":["affected-user-invitation-network-failure-not-reproduced","iphone-safari-tap-stutter-not-device-verified"],"preserved":["per-record-phone-inspection-read-ledger","per-role-call-probability","couple-tasks-opt-in","live-glass-bubble-colors","real-friend-transfer-receipt","four-default-reply-budgets-4096","all-public-v1328-features","role-moment-idb-cover-rehydration","internal-app-decision-hidden-at-all-delivery-boundaries","all-private-v1281-features","private-backup-4mib-object-chunks","private-backup-small-manifest-commit","private-backup-checksum-restore","private-backup-legacy-fallback","private-backup-single-upload-progress","web-cloud-existing-row-update","web-cloud-persistent-progress","private-backup-commit-timeout-1920s","private-call-smart-home-tag-sanitizer","private-call-inline-translation-deduplication","online-memory-recall-controls","offline-memory-scroll-restore","cozy-private-native-bridge","diagnostic-copy-freshness","native-probe-lifecycle","house052-complete-assets","first-person-head-tracking","isolated-mobile-shader-warmup","warm-gpu-resource-release","female-standing-pose","imessage-sms-page","per-contact-sms-background","traced-hairline-glass","thin-bubble-tail","bare-photo-messages","sms-typing-dots","sms-multi-bubble","global-context-everywhere","role-sets-chat-background","sms-photo-vision","frosted-body-with-hairline-ring","rim-picks-up-wallpaper-colour","imessage-text-effects","send-with-effect","fullscreen-screen-effects","cohab-manual-status-sticks","chat-background-keeps-quality","delivery-nested-bracket-actions","lockscreen-touch-ownership-and-drag-reset"]},ensure_ascii=False,indent=2).encode("utf-8")
    ...
    with TemporaryDirectory(prefix="private1329-verify-") as folder:
        with ZipFile(OUTPUT) as archive:
