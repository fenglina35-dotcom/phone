...
test('private performance candidate keeps v1329 while public web advances independently', () => {
  assert.equal(privateIndex, privateAlias);
  assert.match(privateIndex, /window\.__NORTH_SHELL_BUILD__='1329'/);
  assert.match(privateIndex, /app\.js\?v=1329&r=v1329-private-delivery-tag-1/);
