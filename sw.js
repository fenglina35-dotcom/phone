const BUILD='1149';
const HOTFIX='v1149-mood-stability-hotfix-1';
const SHELL_CACHE='north-shell-v1149-mood-stability-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1149-mood-stability-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1149-mood-stability-1'")
