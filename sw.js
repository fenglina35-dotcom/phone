const BUILD='1322';
const HOTFIX='v1322-web-imsg-1';
const SHELL_CACHE='north-shell-v1322-web-imsg-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1322-web-imsg-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1322-web-imsg-1'")
