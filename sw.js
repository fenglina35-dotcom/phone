const BUILD='1122';
const HOTFIX='v1122-sticker-avatar-login-hotfix-3';
const SHELL_CACHE='north-shell-v1122-sticker-avatar-login-3';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=sticker-avatar-login-3',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1122-sticker-avatar-login-3'")
