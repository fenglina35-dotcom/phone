...
test('private performance candidate has a v1237 identity while public web stays v1237', () => {
  assert.equal(privateIndex, privateAlias);
  assert.match(privateIndex, /window\.__NORTH_SHELL_BUILD__='1237'/);
  assert.match(privateIndex, /app\.js\?v=1237&r=v1237-backup-streaming-1/);
