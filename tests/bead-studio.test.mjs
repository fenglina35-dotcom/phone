...
test('game hall routes the shared Bead Atelier in web and private runtimes',()=>{
  ...
  assert.match(html,/bead-studio\.js\?v=1183&r=v1183-pixel-puzzle-4/);
  assert.match(privateHtml,/bead-studio\.js\?v=1183&r=v1183-pixel-puzzle-4/);
  assert.match(sw,/bead-studio\.js\?v='\+BUILD\+'\&r=v1183-pixel-puzzle-4/);
