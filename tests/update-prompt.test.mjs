...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1320'/);
assert.match(html, /sw\.js\?v=1320&r=v1320-web-imsg-1/);
assert.match(html, /web-hotfix\.js\?v=1320&r=v1320-web-imsg-1/);
