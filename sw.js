const BUILD='1167';
const HOTFIX='v1167-heart-cohab-x-memory-hotfix-1';
const SHELL_CACHE='north-shell-v1167-heart-cohab-x-memory-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1167-heart-cohab-x-memory-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1167-heart-cohab-x-memory-1'")
