...
test('v1030 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1030/);
  assert.match(html,/sw\.js\?v=1030&r=v1030-delivery-settlement-1/);
});
