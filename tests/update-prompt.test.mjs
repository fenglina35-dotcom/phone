...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1324'/);
assert.match(html, /sw\.js\?v=1324&r=v1324-web-imsg-1/);
assert.match(html, /web-hotfix\.js\?v=1324&r=v1324-web-imsg-1/);
