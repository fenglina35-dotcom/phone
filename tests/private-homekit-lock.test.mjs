...
test('private release identity is iOS 372 while public web advances independently',()=>{
  ...
  assert.match(project,/CURRENT_PROJECT_VERSION = 372/);
  assert.match(project,/MARKETING_VERSION = 1.0.372/);
