const BUILD='1270';
const HOTFIX='v1270-web-dy-scroll-1';
const SHELL_CACHE='north-shell-v1270-web-dy-scroll-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1270-web-dy-scroll-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1270-web-dy-scroll-1'")
