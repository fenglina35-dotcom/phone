...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1210'/);
assert.match(html, /sw\.js\?v=1210&r=v1210-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1210&r=v1210-couple-watch-trigger-1/);
