...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1190'/);
assert.match(html, /sw\.js\?v=1190&r=v1190-couple-watch-1/);
assert.match(html, /web-hotfix\.js\?v=1190&r=v1190-couple-watch-1/);
