...
test('v1178 has a unique visible identity across every public entry and cache layer',()=>{
  ...
  assert.match(worker,/const BUILD='1326'/);
  assert.match(worker,/north-shell-v1326-web-delivery-tag-1/);
  assert.match(hotfix,/sw\.js\?v=1326&r=v1326-web-delivery-tag-1/);
