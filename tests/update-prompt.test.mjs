...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1272'/);
assert.match(html, /sw\.js\?v=1272&r=v1272-web-compat-social-1/);
assert.match(html, /web-hotfix\.js\?v=1272&r=v1272-web-compat-social-1/);
