...
test('private performance candidate keeps v1317 while public web advances independently', () => {
  assert.equal(privateIndex, privateAlias);
  assert.match(privateIndex, /window\.__NORTH_SHELL_BUILD__='1317'/);
  assert.match(privateIndex, /app\.js\?v=1317&r=v1317-private-imsg-1/);
