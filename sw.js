const BUILD='1245';
const HOTFIX='v1245-offline-narration-truncation-1';
const SHELL_CACHE='north-shell-v1245-offline-narration-truncation-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1245-offline-narration-truncation-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1245-offline-narration-truncation-1'")
