...
test('v1184 web files use one cache-busting build number',()=>{
  ...
  assert.match(app,/const url='sw\.js\?v=1232&r=v1232-cohab-request-timeout-1'/);
  assert.match(html,/__NORTH_SHELL_BUILD__='1232'/);
  assert.match(html,/app\.js\?v=1232/);
  assert.match(sw,/const BUILD='1232'/);
  assert.match(sw,/north-shell-v1232-cohab-request-timeout-1/);
