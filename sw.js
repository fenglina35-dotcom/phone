const BUILD='1156';
const HOTFIX='v1156-via-durable-journal-hotfix-1';
const SHELL_CACHE='north-shell-v1156-via-durable-journal-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1156-via-durable-journal-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1156-via-durable-journal-1'")
