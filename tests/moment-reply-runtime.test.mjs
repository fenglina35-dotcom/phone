...
test('malformed or same-line inner thoughts stay hidden in Moments and ordinary WeChat', () => {
  ...
  assert.match(source, /hiddenThoughtTags=\[[\s\S]*?hadHiddenThought=hiddenThoughtTags\.length>0,hiddenThoughtFailed=[\s\S]*?line=_rawOutput\?modelUnfilteredThoughtTags\(line,c\):stripHiddenThoughtTags\(line,c\)/);
});
