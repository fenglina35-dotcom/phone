...
test('private release identity is iOS 363 while public web stays v1255',()=>{
  ...
  assert.match(project,/CURRENT_PROJECT_VERSION = 363/);
  assert.match(project,/MARKETING_VERSION = 1.0.363/);
  assert.match(read('app.js'),/__NORTH_SHELL_BUILD__!==\'1255\'/);
});
