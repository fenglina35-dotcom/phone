const BUILD='1326';
const HOTFIX='v1326-web-delivery-tag-1';
const SHELL_CACHE='north-shell-v1326-web-delivery-tag-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1326-web-delivery-tag-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1326-web-delivery-tag-1'")
