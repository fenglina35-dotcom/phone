const BUILD='1300';
const HOTFIX='v1300-web-imsg-7';
const SHELL_CACHE='north-shell-v1300-web-imsg-7';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1300-web-imsg-7',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1300-web-imsg-7'")
