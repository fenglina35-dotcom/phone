...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1286'/);
assert.match(html, /sw\.js\?v=1286&r=v1286-web-dy-fullscreen-1/);
assert.match(html, /web-hotfix\.js\?v=1286&r=v1286-web-dy-fullscreen-1/);
