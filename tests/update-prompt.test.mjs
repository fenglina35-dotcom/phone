...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1308'/);
assert.match(html, /sw\.js\?v=1308&r=v1308-web-imsg-1/);
assert.match(html, /web-hotfix\.js\?v=1308&r=v1308-web-imsg-1/);
