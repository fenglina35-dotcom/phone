...
test('private identity remains v1270 and iOS 370 while public advances independently', () => {
  ...
  assert.match(publicIndex, /window\.__NORTH_SHELL_BUILD__='1271'/);
