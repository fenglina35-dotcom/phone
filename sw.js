const BUILD='1125';
const HOTFIX='v1125-chat-continuity-alarm-hotfix-1';
const SHELL_CACHE='north-shell-v1125-chat-continuity-alarm-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=chat-continuity-alarm-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1125-chat-continuity-alarm-1'")
