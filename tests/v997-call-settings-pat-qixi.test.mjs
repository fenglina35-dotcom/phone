...
test('v1009 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1009/);
  assert.match(html,/sw\.js\?v=1009&r=v1009-native-render-thermal-repair-1/);
});
