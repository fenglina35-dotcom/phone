const BUILD='1290';
const HOTFIX='v1290-web-dy-cover-1';
const SHELL_CACHE='north-shell-v1290-web-dy-cover-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1290-web-dy-cover-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1290-web-dy-cover-1'")
