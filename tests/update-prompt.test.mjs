...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1161'/);
assert.match(html, /sw\.js\?v=1161&r=v1161-delivery-unknown-brand-1/);
assert.match(html, /web-hotfix\.js\?v=1161&r=v1161-delivery-unknown-brand-1/);
