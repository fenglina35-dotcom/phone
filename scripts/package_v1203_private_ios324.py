...
NAME = 'SmallPhone_v1203_PixelGirlInteractionFix_iOS324_MacSourceCandidate'
OUTPUT = ROOT.parent / '小手机_v1203_私人版_iOS324_像素少女交互修复_Mac待编译源码包.zip'
...
for token in ["__NORTH_SHELL_BUILD__='1203'",'app.js?v=1203&r=v1203-couple-watch-1','private-runtime-diagnostics.js?v=324','couple-watch.js?v=1203','couple-watch-runtime.js?v=1203','html.north-native-app .phone:has(.offinput)']:
    require(shell, token)
require(shell,'cohab-model-diagnostics.js?v=1203')
require(shell,'request-size-details.js?v=1203')
...
require(app,"APP_VER='v1203 · 像素少女照顾版'")
...
assert project.count('CURRENT_PROJECT_VERSION = 324;') == 12
assert project.count('MARKETING_VERSION = 1.0.324;') == 12
webview=files['PhoneCompanionTest/LocalPhoneWebView.swift'].decode('utf-8')
require(webview,'1.0.324 (324)')
