const BUILD='1308';
const HOTFIX='v1308-web-imsg-1';
const SHELL_CACHE='north-shell-v1308-web-imsg-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1308-web-imsg-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1308-web-imsg-1'")
