...
test('v1178 shared theater asset is byte-identical and loaded after app core',()=>{
  ...
  assert.match(webHtml,/app\.js\?v=1232[^\n]*<\/script>\s*<script src="cohab-theater\.js\?v=1232&r=v1184-ios-web-crash-cohab-turn-keyboard-1"/);
  for(const html of [privateHtml,privateAlias])assert.match(html,/app\.js\?v=1232[^\n]*<\/script>\s*<script src="private-reply-intercept\.js\?v=1232[^\n]*<\/script>\s*<script src="cohab-theater\.js\?v=1232&r=v1184-ios-web-crash-cohab-turn-keyboard-1"/);
...
test('private artifact identity advances independently to v1232 and iOS 1.0.355 (355)',()=>{
  assert.match(privateApp,/const APP_VER='v1232 · 共同生活回复等待修复'/);
