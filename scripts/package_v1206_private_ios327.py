...
GUIDE = '第三百二十七次安装_v1206_完整衣柜_请先读.md'
NAME = 'SmallPhone_v1206_NicknameWardrobe_iOS327_MacSourceCandidate'
OUTPUT = ROOT.parent / '小手机_v1206_私人版_iOS327_昵称提示与自定义衣柜_Mac待编译源码包.zip'
...
for token in ["__NORTH_SHELL_BUILD__='1206'",'app.js?v=1206&r=v1206-couple-watch-1','private-runtime-diagnostics.js?v=327','couple-watch.js?v=1206','couple-watch-runtime.js?v=1206','html.north-native-app .phone:has(.offinput)']:
    require(shell, token)
require(shell,'cohab-model-diagnostics.js?v=1206')
require(shell,'request-size-details.js?v=1206')
...
require(app,"APP_VER='v1206 · 像素少女照顾版'")
...
assert project.count('CURRENT_PROJECT_VERSION = 327;') == 12
assert project.count('MARKETING_VERSION = 1.0.327;') == 12
webview=files['PhoneCompanionTest/LocalPhoneWebView.swift'].decode('utf-8')
require(webview,'1.0.327 (327)')
...
require(files[BUNDLE+'games/pixel-home/index.html'].decode('utf-8'),'wardrobe/data.js?v=1206')
require(files[BUNDLE+'games/pixel-home/wardrobe/index.html'].decode('utf-8'),'body-legWidth')
require(files[BUNDLE+'games/pixel-home/game.js'].decode('utf-8'),'wardrobe/host.js?v=1206')
...
require(files[BUNDLE+'games/pixel-home/game.js'].decode('utf-8'),"const arrangingText='等待'+")
require(files[BUNDLE+'games/pixel-home/game.js'].decode('utf-8'),"step(arrangingText);")
assert '等待角色安排' not in files[BUNDLE+'games/pixel-home/game.js'].decode('utf-8')
files['SOURCE_COMMIT.txt']=(f'branch=main\ncommit={head}\nworktree=clean\nscope=shared\npublic-source=v1206 (LOCAL WEB ZIP; NOT PUSHED)\nprivate-web=v1206\nios=1.0.327 (327)\nbridge=35\nmac-compile-verified=no\nreal-iphone-verified=no\n').encode()
