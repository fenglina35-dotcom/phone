...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1142'/);
assert.match(html, /sw\.js\?v=1142&r=v1142-smart-home-verified-lamp-1/);
assert.match(html, /web-hotfix\.js\?v=1142&r=v1142-smart-home-verified-lamp-1/);
