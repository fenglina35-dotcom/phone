...
test('private release identity is iOS 339 while public web stays v1213',()=>{
  ...
  assert.match(project,/CURRENT_PROJECT_VERSION = 339/);
  assert.match(project,/MARKETING_VERSION = 1\.0\.339/);
