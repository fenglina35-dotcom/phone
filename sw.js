const BUILD='1128';
const HOTFIX='v1128-backup-offline-failure-evidence-hotfix-1';
const SHELL_CACHE='north-shell-v1128-backup-offline-failure-evidence-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1128-backup-offline-failure-evidence-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1128-backup-offline-failure-evidence-1'")
