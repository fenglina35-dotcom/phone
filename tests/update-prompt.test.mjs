...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1215'/);
assert.match(html, /sw\.js\?v=1215&r=v1215-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1215&r=v1215-couple-watch-trigger-1/);
