const BUILD='1268';
const HOTFIX='v1268-web-dy-group-1';
const SHELL_CACHE='north-shell-v1268-web-dy-group-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1268-web-dy-group-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1268-web-dy-group-1'")
