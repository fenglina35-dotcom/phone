...
for path in files:
    ...
    if "v1029｜" not in text:
        raise RuntimeError(f"{path.name}: missing v1029 section")
...
print("v1029 maintenance DOCX structure checks passed; visual render unavailable without LibreOffice/Word")
