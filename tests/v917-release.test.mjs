...
test('v1037 web source keeps private 1.0.157 compatibility', () => {
  ...
  assert.equal((project.match(/CURRENT_PROJECT_VERSION = 157;/g) || []).length, 12);
  assert.equal((project.match(/MARKETING_VERSION = 1\.0\.157;/g) || []).length, 12);
