const BUILD='1280';
const HOTFIX='v1280-smart-home-quota-guard-1';
const SHELL_CACHE='north-shell-v1280-smart-home-quota-guard-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1280-smart-home-quota-guard-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1280-smart-home-quota-guard-1'")
