...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1312'/);
assert.match(html, /sw\.js\?v=1312&r=v1312-web-imsg-1/);
assert.match(html, /web-hotfix\.js\?v=1312&r=v1312-web-imsg-1/);
