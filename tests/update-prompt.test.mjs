...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1200'/);
assert.match(html, /sw\.js\?v=1200&r=v1200-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1200&r=v1200-couple-watch-trigger-1/);
