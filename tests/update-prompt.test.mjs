...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1128'/);
assert.match(html, /sw\.js\?v=1128&r=v1128-backup-offline-failure-evidence-1/);
assert.match(html, /web-hotfix\.js\?v=1128&r=v1128-backup-offline-failure-evidence-1/);
