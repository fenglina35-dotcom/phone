...
test('v1088 web and private iOS 1.0.213 keep explicit build identities', () => {
  assert.match(app, /APP_VER='v1088 · 抖音锁定与限额回退修复版'/);
  assert.match(app, /sw\.js\?v=1088&r=v1088-screen-time-control-rollback-1/);
  assert.match(shell, /north-shell-v1088/);
  assert.match(bundleInfo, /<string>1088<\/string>/);
  assert.match(localWebView, /1\.0\.213 \(213\)/);
