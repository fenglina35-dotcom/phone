const BUILD='1260';
const HOTFIX='v1260-web-call-retry-1';
const SHELL_CACHE='north-shell-v1260-web-call-retry-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1260-web-call-retry-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1260-web-call-retry-1'")
