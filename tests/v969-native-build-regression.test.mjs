...
test('v1035 web and private iOS 1.0.154 keep explicit build identities', () => {
  assert.match(app, /APP_VER='v1035 · 微信发现页与附近好友'/);
  assert.match(app, /sw\.js\?v=1035&r=v1035-wechat-discover-1/);
  assert.match(shell, /north-shell-v1035/);
  assert.match(bundleInfo, /<string>1035<\/string>/);
