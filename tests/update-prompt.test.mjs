...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1257'/);
assert.match(html, /sw\.js\?v=1257&r=v1257-web-app-control-1/);
assert.match(html, /web-hotfix\.js\?v=1257&r=v1257-web-app-control-1/);
