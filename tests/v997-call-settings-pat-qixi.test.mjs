...
test('v1014 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1014/);
  assert.match(html,/sw\.js\?v=1014&r=v1014-companion-unlock-remote-natural-caption-1/);
});
