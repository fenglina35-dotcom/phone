...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1125'/);
assert.match(html, /sw\.js\?v=1125&r=v1125-chat-continuity-alarm-1/);
assert.match(html, /web-hotfix\.js\?v=1125&r=chat-continuity-alarm-1/);
