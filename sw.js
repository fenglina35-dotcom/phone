const BUILD='1123';
const HOTFIX='v1123-route-diagnostics-hotfix-1';
const SHELL_CACHE='north-shell-v1123-wardrobe-time-range-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=wardrobe-time-range-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1123-route-diagnostics-1'")
