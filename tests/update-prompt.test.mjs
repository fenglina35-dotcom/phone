...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1206'/);
assert.match(html, /sw\.js\?v=1206&r=v1206-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1206&r=v1206-couple-watch-trigger-1/);
