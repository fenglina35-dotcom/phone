...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1150'/);
assert.match(html, /sw\.js\?v=1150&r=v1150-delivery-auth-recovery-1/);
assert.match(html, /web-hotfix\.js\?v=1150&r=v1150-delivery-auth-recovery-1/);
