"""Create the private v1303 / iOS 385 Mac-source overlay package.
...
PREFIX = "SmallPhone_v1303_iOS385_Private/"
OUTPUT = ROOT.parent / "SmallPhone_v1303_iOS385_MacSource.zip"
...
def validate(files: dict[str, bytes]) -> None:
    ...
    for marker, label in [
        ...
        ("@keyframes imfx-burst{", "v1300 文字特效·爆发"),
