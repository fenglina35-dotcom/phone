const BUILD='1151';
const HOTFIX='v1151-android-backup-import-hotfix-1';
const SHELL_CACHE='north-shell-v1151-android-backup-import-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1151-android-backup-import-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1151-android-backup-import-1'")
