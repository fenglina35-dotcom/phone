...
GUIDE = '第三百二十次安装_v1198_请求规模详情_请先读.md'
NAME = 'SmallPhone_v1198_RequestSize_iOS320_MacSourceCandidate'
OUTPUT = ROOT.parent / '小手机_v1198_私人版_iOS320_请求规模详情_Mac待编译源码包.zip'
...
for token in ["__NORTH_SHELL_BUILD__='1198'",'app.js?v=1198&r=v1198-couple-watch-1','private-runtime-diagnostics.js?v=320','couple-watch.js?v=1198','couple-watch-runtime.js?v=1198','html.north-native-app .phone:has(.offinput)']:
    require(shell, token)
require(shell,'cohab-model-diagnostics.js?v=1198')
require(shell,'request-size-details.js?v=1198')
require(app,'requestSizeDetailsHtml(d)')
require(app,"APP_VER='v1198 · 请求规模详情版'")
...
for name in ['request-size-details.js','cohab-model-diagnostics.js','couple-watch.js','couple-watch-runtime.js','cohab-theater.js','bead-studio.js','heart-quiz.js']:
