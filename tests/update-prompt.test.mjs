...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1141'/);
assert.match(html, /sw\.js\?v=1141&r=v1141-cohab-memory-x-comments-1/);
assert.match(html, /web-hotfix\.js\?v=1141&r=v1141-cohab-memory-x-comments-1/);
