...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1198'/);
assert.match(html, /sw\.js\?v=1198&r=v1198-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1198&r=v1198-couple-watch-trigger-1/);
