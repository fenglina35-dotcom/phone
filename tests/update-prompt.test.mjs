...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1265'/);
assert.match(html, /sw\.js\?v=1265&r=v1265-web-douyin-people-1/);
assert.match(html, /web-hotfix\.js\?v=1265&r=v1265-web-douyin-people-1/);
