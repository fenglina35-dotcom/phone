...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1179'/);
assert.match(html, /sw\.js\?v=1179&r=v1179-format-bead-fix-1/);
assert.match(html, /web-hotfix\.js\?v=1179&r=v1179-format-bead-fix-1/);
