...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1166'/);
assert.match(html, /sw\.js\?v=1166&r=v1166-heartquiz-batches-1/);
assert.match(html, /web-hotfix\.js\?v=1166&r=v1166-heartquiz-batches-1/);
