"""Create the private v1283 / iOS 380 Mac-source overlay package.
...
PREFIX = "SmallPhone_v1283_iOS380_Private/"
OUTPUT = ROOT.parent / "SmallPhone_v1283_iOS380_MacSource.zip"
...
def main() -> None:
    ...
    with TemporaryDirectory(prefix="private1283-verify-") as folder:
        with ZipFile(OUTPUT) as archive:
