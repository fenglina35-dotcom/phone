...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1328'/);
assert.match(html, /sw\.js\?v=1328&r=v1328-web-delivery-tag-1/);
assert.match(html, /web-hotfix\.js\?v=1328&r=v1328-web-delivery-tag-1/);
