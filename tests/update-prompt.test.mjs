...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1244'/);
assert.match(html, /sw\.js\?v=1244&r=v1244-import-memory-release-1/);
assert.match(html, /web-hotfix\.js\?v=1244&r=v1244-import-memory-release-1/);
