...
test('private identity advances to v1238 and iOS 355 while public remains v1238', () => {
  assert.match(privateApp, /__NORTH_SHELL_BUILD__!=='1238'/);
  ...
  assert.match(publicIndex, /window\.__NORTH_SHELL_BUILD__='1238'/);
