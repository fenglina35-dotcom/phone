...
def replace(path, old, new, expected=None):
    ...
    if count == 0 and (expected is None or text.count(new) >= expected):
        return
...
replace("小手机.html", "?v=1036", "?v=1037", 8)
