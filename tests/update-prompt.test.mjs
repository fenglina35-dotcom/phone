...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1184'/);
assert.match(html, /sw\.js\?v=1184&r=v1184-ios-web-crash-cohab-turn-keyboard-1/);
assert.match(html, /web-hotfix\.js\?v=1184&r=v1184-ios-web-crash-cohab-turn-keyboard-1/);
