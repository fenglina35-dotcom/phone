...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1213'/);
assert.match(html, /sw\.js\?v=1213&r=v1213-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1213&r=v1213-couple-watch-trigger-1/);
