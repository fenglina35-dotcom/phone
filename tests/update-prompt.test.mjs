...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1322'/);
assert.match(html, /sw\.js\?v=1322&r=v1322-web-imsg-1/);
assert.match(html, /web-hotfix\.js\?v=1322&r=v1322-web-imsg-1/);
