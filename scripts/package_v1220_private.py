...
def main():
 ...
 assert "APP_VER='v1220 · 私人整合修复版'" in app and "__NORTH_SHELL_BUILD__='1220'" in html
 ...
 assert pbx.count('CURRENT_PROJECT_VERSION = 344;')==12 and pbx.count('MARKETING_VERSION = 1.0.344;')==12
 ...
 files[BUNDLE+'sw.js']=data['sw.js'].decode().replace("BUILD='1216'","BUILD='1220'").replace('v1216','v1220').encode()
 ...
 out=ROOT.parent/'小手机_v1220_私人版_iOS344_智能家居与卡顿修复_后台待更新_Mac待编译源码包.zip'
 assert not out.exists(),'Never overwrite old packages'
 prefix='SmallPhone_v1220_iOS344_MacSource/'
