...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1216'/);
assert.match(html, /sw\.js\?v=1216&r=v1216-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1216&r=v1216-couple-watch-trigger-1/);
