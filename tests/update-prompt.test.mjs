...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1263'/);
assert.match(html, /sw\.js\?v=1263&r=v1263-web-douyin-glass-1/);
assert.match(html, /web-hotfix\.js\?v=1263&r=v1263-web-douyin-glass-1/);
