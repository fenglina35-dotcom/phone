...
test('v1038 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1038/);
  assert.match(html,/sw\.js\?v=1038&r=v1038-real-delivery-reply-1/);
});
