...
test('private identity remains v1279 and iOS 378 while public advances independently', () => {
  assert.match(privateApp, /__NORTH_SHELL_BUILD__!=='1279'/);
