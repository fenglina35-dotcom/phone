...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1159'/);
assert.match(html, /sw\.js\?v=1159&r=v1159-wechat-text-auto-translation-1/);
assert.match(html, /web-hotfix\.js\?v=1159&r=v1159-wechat-text-auto-translation-1/);
