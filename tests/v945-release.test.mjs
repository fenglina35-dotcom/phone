...
test('the private iOS source embeds private web v1184 and keeps native build 312 before repackaging',()=>{
  assert.match(privateBundle,/<string>1184<\/string>/);
  assert.equal((xcode.match(/MARKETING_VERSION = 1\.0\.312;/g)||[]).length,12);
  assert.equal((xcode.match(/CURRENT_PROJECT_VERSION = 312;/g)||[]).length,12);
