...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1191'/);
assert.match(html, /sw\.js\?v=1191&r=v1191-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1191&r=v1191-couple-watch-trigger-1/);
