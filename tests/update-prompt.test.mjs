...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1177'/);
assert.match(html, /sw\.js\?v=1177&r=v1177-proactive-delivery-target-1/);
assert.match(html, /web-hotfix\.js\?v=1177&r=v1177-proactive-delivery-target-1/);
