...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1260'/);
assert.match(html, /sw\.js\?v=1260&r=v1260-web-call-retry-1/);
assert.match(html, /web-hotfix\.js\?v=1260&r=v1260-web-call-retry-1/);
