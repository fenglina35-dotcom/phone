...
test('private release identity is iOS 369 while public web stays v1269',()=>{
  ...
  assert.match(project,/CURRENT_PROJECT_VERSION = 369/);
  assert.match(project,/MARKETING_VERSION = 1.0.369/);
  assert.match(read('app.js'),/__NORTH_SHELL_BUILD__!==\'1269\'/);
});
