...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1251'/);
assert.match(html, /sw\.js\?v=1251&r=v1251-web-seven-fixes-1/);
assert.match(html, /web-hotfix\.js\?v=1251&r=v1251-web-seven-fixes-1/);
