...
test('v1178 has a unique visible identity across every public entry and cache layer',()=>{
  ...
  assert.match(worker,/const BUILD='1280'/);
  assert.match(worker,/north-shell-v1280-smart-home-quota-guard-1/);
  assert.match(hotfix,/sw\.js\?v=1280&r=v1280-smart-home-quota-guard-1/);
