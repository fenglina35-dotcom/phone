...
test('private identity remains v1289 and iOS 380 while public advances independently', () => {
  assert.match(privateApp, /__NORTH_SHELL_BUILD__!=='1289'/);
  ...
  assert.match(publicIndex, /window\.__NORTH_SHELL_BUILD__='1288'/);
