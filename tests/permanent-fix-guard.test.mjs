...
const PERMANENT_FIXES = [
  ...
  },
  {
    ...
    scope: 'web',
    file: '小手机.html',
    marker: '.imsg-row.them .imsg-b{padding:8px 14px 8px 23px;clip-path:polygon(',
    least: 1,
  },
  {
    release: 'v1294/v1295',
    name: '网页外壳：玻璃的白边是左上实右下虚的高光，不是一圈包边',
    scope: 'web',
    file: '小手机.html',
    marker: 'border:0;background:linear-gradient(140deg,rgba(255,255,255,.34)',
    least: 1,
  },
  {
    release: 'v1294/v1295',
    name: '网页外壳：贴边那一圈单独折射（mask 差集挖出来的圈）',
    scope: 'web',
    file: '小手机.html',
    marker: 'mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude',
    least: 1,
  },
  {
    release: 'v1294/v1295',
  ...
  {
    release: 'v1294/v1295',
    name: '私人外壳：玻璃的白边是左上实右下虚的高光，不是一圈包边',
    scope: 'web',
    file: 'native/private-small-phone/XcodeProject/PhoneCompanionTest/PhoneWeb.bundle/小手机.html',
    marker: 'border:0;background:linear-gradient(140deg,rgba(255,255,255,.34)',
    least: 1,
  ...
  {
    release: 'v1294/v1295',
    name: '私人外壳：贴边那一圈单独折射（mask 差集挖出来的圈）',
    scope: 'web',
    file: 'native/private-small-phone/XcodeProject/PhoneCompanionTest/PhoneWeb.bundle/小手机.html',
    marker: 'mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude',
    least: 1,
  ...
  {
    release: 'v1294/v1295',
    name: '私人入口：玻璃的白边是左上实右下虚的高光，不是一圈包边',
    scope: 'web',
    file: 'native/private-small-phone/XcodeProject/PhoneCompanionTest/PhoneWeb.bundle/index.html',
    marker: 'border:0;background:linear-gradient(140deg,rgba(255,255,255,.34)',
    least: 1,
  ...
  {
    release: 'v1294/v1295',
    name: '私人入口：贴边那一圈单独折射（mask 差集挖出来的圈）',
    scope: 'web',
    file: 'native/private-small-phone/XcodeProject/PhoneCompanionTest/PhoneWeb.bundle/index.html',
    marker: 'mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);mask-composite:exclude',
    least: 1,
