...
test('v1039 web and private iOS 1.0.158 keep explicit build identities', () => {
  assert.match(app, /APP_VER='v1039 · 微信个人页与客服完善版'/);
  assert.match(app, /sw\.js\?v=1039&r=v1039-wechat-pages-1/);
  assert.match(shell, /north-shell-v1039/);
