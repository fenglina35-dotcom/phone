...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1292'/);
assert.match(html, /sw\.js\?v=1292&r=v1292-web-dy-rail-1/);
assert.match(html, /web-hotfix\.js\?v=1292&r=v1292-web-dy-rail-1/);
