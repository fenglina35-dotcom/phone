...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1284'/);
assert.match(html, /sw\.js\?v=1284&r=v1284-web-dy-publish-1/);
assert.match(html, /web-hotfix\.js\?v=1284&r=v1284-web-dy-publish-1/);
