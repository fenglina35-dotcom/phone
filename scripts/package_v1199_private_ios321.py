...
GUIDE = '第三百二十一次安装_v1199_外卖补判降耗_请先读.md'
NAME = 'SmallPhone_v1199_DeliveryCost_iOS321_MacSourceCandidate'
OUTPUT = ROOT.parent / '小手机_v1199_私人版_iOS321_外卖补判降耗_Mac待编译源码包.zip'
...
for token in ["__NORTH_SHELL_BUILD__='1199'",'app.js?v=1199&r=v1199-couple-watch-1','private-runtime-diagnostics.js?v=321','couple-watch.js?v=1199','couple-watch-runtime.js?v=1199','html.north-native-app .phone:has(.offinput)']:
    require(shell, token)
require(shell,'cohab-model-diagnostics.js?v=1199')
require(shell,'request-size-details.js?v=1199')
...
require(app,"APP_VER='v1199 · 外卖补判降耗版'")
