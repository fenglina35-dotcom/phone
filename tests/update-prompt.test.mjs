...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1165'/);
assert.match(html, /sw\.js\?v=1165&r=v1165-reply-heartquiz-homekit-1/);
assert.match(html, /web-hotfix\.js\?v=1165&r=v1165-reply-heartquiz-homekit-1/);
