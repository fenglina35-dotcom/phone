...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1298'/);
assert.match(html, /sw\.js\?v=1298&r=v1298-web-imsg-4/);
assert.match(html, /web-hotfix\.js\?v=1298&r=v1298-web-imsg-4/);
