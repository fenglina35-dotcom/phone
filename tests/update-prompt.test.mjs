...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1197'/);
assert.match(html, /sw\.js\?v=1197&r=v1197-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1197&r=v1197-couple-watch-trigger-1/);
