...
test('v1008 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1008/);
  assert.match(html,/sw\.js\?v=1008&r=v1008-shared-album-moments-stability-1/);
});
