const BUILD='1282';
const HOTFIX='v1282-app-decision-visibility-1';
const SHELL_CACHE='north-shell-v1282-app-decision-visibility-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1282-app-decision-visibility-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='theater')return text.length>30000
    &&text.includes("window.__NORTH_COHAB_THEATER__='v1274-web-cohab-guests-1'")
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1282-app-decision-visibility-1'")
