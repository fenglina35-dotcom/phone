...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1149'/);
assert.match(html, /sw\.js\?v=1149&r=v1149-mood-stability-1/);
assert.match(html, /web-hotfix\.js\?v=1149&r=v1149-mood-stability-1/);
