...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1193'/);
assert.match(html, /sw\.js\?v=1193&r=v1193-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1193&r=v1193-couple-watch-trigger-1/);
