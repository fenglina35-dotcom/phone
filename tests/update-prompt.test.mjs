...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1302'/);
assert.match(html, /sw\.js\?v=1302&r=v1302-web-imsg-1/);
assert.match(html, /web-hotfix\.js\?v=1302&r=v1302-web-imsg-1/);
