"""Create the private v1281 / iOS 379 Mac-source overlay package.
...
PREFIX = "SmallPhone_v1281_iOS379_Private/"
OUTPUT = ROOT.parent / "SmallPhone_v1281_iOS379_MacSource.zip"
...
def main() -> None:
    ...
    with TemporaryDirectory(prefix="private1281-verify-") as folder:
        with ZipFile(OUTPUT) as archive:
