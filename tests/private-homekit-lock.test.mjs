...
test('private release identity is iOS 351 while public web stays v1229',()=>{
  ...
  assert.match(project,/CURRENT_PROJECT_VERSION = 351/);
  assert.match(project,/MARKETING_VERSION = 1\.0\.351/);
  assert.match(read('app.js'),/__NORTH_SHELL_BUILD__!==\'1229\'/);
});
