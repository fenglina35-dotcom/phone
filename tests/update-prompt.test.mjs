...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1259'/);
assert.match(html, /sw\.js\?v=1259&r=v1259-web-douyin-profile-1/);
assert.match(html, /web-hotfix\.js\?v=1259&r=v1259-web-douyin-profile-1/);
