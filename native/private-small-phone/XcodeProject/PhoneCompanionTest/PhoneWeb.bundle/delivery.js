...
(function(){
  ...
  function resultReply(c,order,error){
    ...
    if(error){roleSystemNotice((order?'外卖流程已生成订单卡片，但付款入口未完成：':'真实外卖未完成：')+text(error,150),'error');return;}
