...
test('v1021 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1021/);
  assert.match(html,/sw\.js\?v=1021&r=v1021-native-core-boot-bridge-repair-1/);
});
