...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1249'/);
assert.match(html, /sw\.js\?v=1249&r=v1249-web-six-fixes-1/);
assert.match(html, /web-hotfix\.js\?v=1249&r=v1249-web-six-fixes-1/);
