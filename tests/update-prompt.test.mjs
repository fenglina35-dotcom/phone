...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1151'/);
assert.match(html, /sw\.js\?v=1151&r=v1151-android-backup-import-1/);
assert.match(html, /web-hotfix\.js\?v=1151&r=v1151-android-backup-import-1/);
