...
PACKAGE_NAME = "SmallPhone_v1035_RealMilkTea_iOS155_MacReady"
STAGING = DELIVERY / PACKAGE_NAME
ZIP_PATH = DELIVERY / f"{PACKAGE_NAME}.zip"
INSTALL_GUIDE = "第一百五十五次安装_v1035_真实奶茶偏好与快速点单_请先读.md"
...
if "APP_VER='v1035 · 真实奶茶偏好与快速点单';" not in app_text:
...
if project_text.count("CURRENT_PROJECT_VERSION = 155;") != 12:
    raise RuntimeError("private iOS build number is not consistently 155")
if project_text.count("MARKETING_VERSION = 1.0.155;") != 12:
    raise RuntimeError("private iOS marketing version is not consistently 1.0.155")
