const BUILD='1261';
const HOTFIX='v1261-web-douyin-message-1';
const SHELL_CACHE='north-shell-v1261-web-douyin-message-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1261-web-douyin-message-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1261-web-douyin-message-1'")
