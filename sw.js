const BUILD='1275';
const HOTFIX='v1275-web-cloud-sync-1';
const SHELL_CACHE='north-shell-v1275-web-cloud-sync-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1275-web-cloud-sync-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1275-web-cloud-sync-1'")
