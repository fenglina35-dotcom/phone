...
test('the web shell and service worker require the hotfix while private files stay outside its entry path',()=>{
  assert.match(shell,/web-hotfix\.js\?v=1125&r=chat-continuity-alarm-1/);
  assert.match(hotfix,/sw\.js\?v=1125&r=v1125-chat-continuity-alarm-1/);
  assert.match(worker,/kind:'hotfix'/);
  assert.match(worker,/north-shell-v1125-chat-continuity-alarm-1/);
