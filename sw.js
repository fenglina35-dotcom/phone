const BUILD='1203';
const HOTFIX='v1203-couple-watch-trigger-1';
const SHELL_CACHE='north-shell-v1203-couple-watch-trigger-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1203-couple-watch-trigger-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1203-couple-watch-trigger-1'")
