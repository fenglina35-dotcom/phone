const BUILD='1216';
const HOTFIX='v1216-couple-watch-trigger-1';
const SHELL_CACHE='north-shell-v1216-couple-watch-trigger-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1216-couple-watch-trigger-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1216-couple-watch-trigger-1'")
