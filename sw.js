const BUILD='1169';
const HOTFIX='v1169-heartquiz-progressive-fill-hotfix-1';
const SHELL_CACHE='north-shell-v1169-heartquiz-progressive-fill-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1169-heartquiz-progressive-fill-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1169-heartquiz-progressive-fill-1'")
