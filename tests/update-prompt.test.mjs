...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1288'/);
assert.match(html, /sw\.js\?v=1288&r=v1288-web-dy-solid-1/);
assert.match(html, /web-hotfix\.js\?v=1288&r=v1288-web-dy-solid-1/);
