...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1294'/);
assert.match(html, /sw\.js\?v=1294&r=v1294-web-imsg-1/);
assert.match(html, /web-hotfix\.js\?v=1294&r=v1294-web-imsg-1/);
