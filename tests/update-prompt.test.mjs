...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1153'/);
assert.match(html, /sw\.js\?v=1153&r=v1153-delivery-identity-intercept-release-1/);
assert.match(html, /web-hotfix\.js\?v=1153&r=v1153-delivery-identity-intercept-release-1/);
