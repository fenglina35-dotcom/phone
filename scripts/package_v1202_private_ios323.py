...
NAME = 'SmallPhone_v1202_PixelGirlCare_iOS323_MacSourceCandidate'
OUTPUT = ROOT.parent / '小手机_v1202_私人版_iOS323_像素少女照顾版_Mac待编译源码包.zip'
...
for token in ["__NORTH_SHELL_BUILD__='1202'",'app.js?v=1202&r=v1202-couple-watch-1','private-runtime-diagnostics.js?v=323','couple-watch.js?v=1202','couple-watch-runtime.js?v=1202','html.north-native-app .phone:has(.offinput)']:
    require(shell, token)
require(shell,'cohab-model-diagnostics.js?v=1202')
require(shell,'request-size-details.js?v=1202')
...
assert project.count('CURRENT_PROJECT_VERSION = 323;') == 12
assert project.count('MARKETING_VERSION = 1.0.323;') == 12
webview=files['PhoneCompanionTest/LocalPhoneWebView.swift'].decode('utf-8')
require(webview,'1.0.323 (323)')
