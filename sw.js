const BUILD='1145';
const HOTFIX='v1145-cohab-entry-webkit-hotfix-1';
const SHELL_CACHE='north-shell-v1145-cohab-entry-webkit-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1145-cohab-entry-webkit-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1145-cohab-entry-webkit-1'")
