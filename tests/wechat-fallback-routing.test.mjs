...
assert.match(source,/_md=\{roleReplyLanguageGuard:true,routeIndex:_routeIndex,aux:c\.model==='aux',complete:!_rawOutput,unfilteredOutput:_rawOutput,roleInterceptAudit:_replyAudit,roleInterceptStage:'微信回复候选'\}/);
