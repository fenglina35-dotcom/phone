...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1310'/);
assert.match(html, /sw\.js\?v=1310&r=v1310-web-imsg-1/);
assert.match(html, /web-hotfix\.js\?v=1310&r=v1310-web-imsg-1/);
