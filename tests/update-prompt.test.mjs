...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1148'/);
assert.match(html, /sw\.js\?v=1148&r=v1148-android-startup-route-1/);
assert.match(html, /web-hotfix\.js\?v=1148&r=v1148-android-startup-route-1/);
