const BUILD='1271';
const HOTFIX='v1271-web-compat-social-1';
const SHELL_CACHE='north-shell-v1271-web-compat-social-1';
...
const CORE_FILES=[
  ...
  {url:'./cohab-theater.js?v='+BUILD+'&r=v1271-web-cohab-guests-1',kind:'theater'},
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1271-web-compat-social-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='theater')return text.length>30000
    &&text.includes("window.__NORTH_COHAB_THEATER__='v1271-web-cohab-guests-1'")
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1271-web-compat-social-1'")
