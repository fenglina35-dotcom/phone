...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1196'/);
assert.match(html, /sw\.js\?v=1196&r=v1196-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1196&r=v1196-couple-watch-trigger-1/);
