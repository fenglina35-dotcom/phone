...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1318'/);
assert.match(html, /sw\.js\?v=1318&r=v1318-web-imsg-1/);
assert.match(html, /web-hotfix\.js\?v=1318&r=v1318-web-imsg-1/);
