...
test('v1156 web and private iOS 1.0.253 keep explicit build identities', () => {
  assert.match(app, /APP_VER='v1156 · 安卓大存档增量恢复版'/);
  assert.match(app, /sw\.js\?v=1156&r=v1156-via-durable-journal-1/);
  assert.match(shell, /north-shell-v1156/);
