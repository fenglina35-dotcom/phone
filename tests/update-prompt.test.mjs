...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1326'/);
assert.match(html, /sw\.js\?v=1326&r=v1326-web-delivery-tag-1/);
assert.match(html, /web-hotfix\.js\?v=1326&r=v1326-web-delivery-tag-1/);
