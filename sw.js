const BUILD='1171';
const HOTFIX='v1171-cohab-theater-hotfix-1';
const SHELL_CACHE='north-shell-v1171-cohab-theater-1';
...
const CORE_FILES=[
  ...
  {url:'./cohab-theater.js?v='+BUILD+'&r=v1171-cohab-theater-1',kind:'theater'},
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1171-cohab-theater-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='theater')return text.length>30000
    &&text.includes("window.__NORTH_COHAB_THEATER__='v1171-cohab-theater-1'")
    &&text.includes('cohabTheaterSummarizeEpisode')
    &&text.includes('cohab-theater-bar');
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1171-cohab-theater-1'")
