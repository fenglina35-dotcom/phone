...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1204'/);
assert.match(html, /sw\.js\?v=1204&r=v1204-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1204&r=v1204-couple-watch-trigger-1/);
