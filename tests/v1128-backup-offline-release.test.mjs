...
test('v1164 has a unique visible identity across every public entry and cache layer',()=>{
  ...
  assert.match(worker,/const BUILD='1164'/);
  assert.match(worker,/north-shell-v1164-scroll-camera-smart-home-1/);
  assert.match(hotfix,/sw\.js\?v=1164&r=v1164-scroll-camera-smart-home-1/);
