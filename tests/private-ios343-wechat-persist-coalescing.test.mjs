...
test('private identity advances to v1226 and iOS 349 while public remains v1226', () => {
  assert.match(privateApp, /__NORTH_SHELL_BUILD__!=='1226'/);
