...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1205'/);
assert.match(html, /sw\.js\?v=1205&r=v1205-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1205&r=v1205-couple-watch-trigger-1/);
