...
test('v1032 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1032/);
  assert.match(html,/sw\.js\?v=1032&r=v1032-wechat-chat-1/);
});
