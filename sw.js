const BUILD='1150';
const HOTFIX='v1150-delivery-auth-recovery-hotfix-1';
const SHELL_CACHE='north-shell-v1150-delivery-auth-recovery-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1150-delivery-auth-recovery-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1150-delivery-auth-recovery-1'")
