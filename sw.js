const BUILD='1127';
const HOTFIX='v1127-intercept-diagnostics-hotfix-1';
const SHELL_CACHE='north-shell-v1127-intercept-diagnostics-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1127-intercept-diagnostics-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1127-intercept-diagnostics-1'")
