...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1255'/);
assert.match(html, /sw\.js\?v=1255&r=v1255-web-reply-pipeline-1/);
assert.match(html, /web-hotfix\.js\?v=1255&r=v1255-web-reply-pipeline-1/);
