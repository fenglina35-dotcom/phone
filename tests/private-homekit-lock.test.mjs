...
test('private release identity is iOS 370 while public web advances independently',()=>{
  ...
  assert.match(project,/CURRENT_PROJECT_VERSION = 370/);
  assert.match(project,/MARKETING_VERSION = 1.0.370/);
