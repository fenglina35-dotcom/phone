...
test('v1018 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1018/);
  assert.match(html,/sw\.js\?v=1018&r=v1018-native-interaction-thermal-repair-1/);
});
