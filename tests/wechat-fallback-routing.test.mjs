...
assert.match(source,/_md=\{roleReplyLanguageGuard:true,routeIndex:_routeIndex,aux:c\.model==='aux',complete:true,unfilteredOutput:_rawOutput,roleInterceptAudit:_replyAudit,roleInterceptStage:'微信回复候选',roleVoiceFormatRepair:true,roleVoiceRequested:_voiceRequired\}/);
