"""Create the private v1307 / iOS 387 Mac-source overlay package.
...
PREFIX = "SmallPhone_v1307_iOS387_Private/"
OUTPUT = ROOT.parent / "SmallPhone_v1307_iOS387_MacSource.zip"
...
def validate(files: dict[str, bytes]) -> None:
    ...
    for marker, label in [
        ...
        ("const dir=i%2?1:-1,bx=dir*(96+((i*37)%74))", "v1307 爆发方向按序号算死，不用随机"),
