...
test('private identity remains v1301 and iOS 384 while public advances independently', () => {
  assert.match(privateApp, /__NORTH_SHELL_BUILD__!=='1301'/);
  ...
  assert.match(publicIndex, /window\.__NORTH_SHELL_BUILD__='1300'/);
