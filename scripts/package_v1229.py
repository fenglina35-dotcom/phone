...
def validate(web,private):
 ...
 assert project.count('CURRENT_PROJECT_VERSION = 351;')==12 and project.count('MARKETING_VERSION = 1.0.351;')==12
...
def main():
 ...
 for scope,files,name,prefix in [('私人',private,'小手机_v1229_私人版_iOS351_语音修复与日常事件簿_Mac待编译源码包.zip','SmallPhone_v1229_iOS351_MacSource/')]:
