...
test('v1034 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1034/);
  assert.match(html,/sw\.js\?v=1034&r=v1034-wechat-contacts-fixed-1/);
});
