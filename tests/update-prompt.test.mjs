...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1194'/);
assert.match(html, /sw\.js\?v=1194&r=v1194-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1194&r=v1194-couple-watch-trigger-1/);
