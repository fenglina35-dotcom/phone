const BUILD='1257';
const HOTFIX='v1257-web-app-control-1';
const SHELL_CACHE='north-shell-v1257-web-app-control-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1257-web-app-control-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1257-web-app-control-1'")
