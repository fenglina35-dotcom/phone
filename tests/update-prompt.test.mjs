...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1241'/);
assert.match(html, /sw\.js\?v=1241&r=v1241-backup-streaming-1/);
assert.match(html, /web-hotfix\.js\?v=1241&r=v1241-backup-streaming-1/);
