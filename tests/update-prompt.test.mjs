...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1290'/);
assert.match(html, /sw\.js\?v=1290&r=v1290-web-dy-cover-1/);
assert.match(html, /web-hotfix\.js\?v=1290&r=v1290-web-dy-cover-1/);
