...
test('v1178 shared theater asset is byte-identical and loaded after app core',()=>{
  ...
  assert.match(webHtml,/app\.js\?v=1215[^\n]*<\/script>\s*<script src="cohab-theater\.js\?v=1215&r=v1184-ios-web-crash-cohab-turn-keyboard-1"/);
  for(const html of [privateHtml,privateAlias])assert.match(html,/app\.js\?v=1215[^\n]*<\/script>\s*<script src="private-reply-intercept\.js\?v=1215[^\n]*<\/script>\s*<script src="cohab-theater\.js\?v=1215&r=v1184-ios-web-crash-cohab-turn-keyboard-1"/);
...
test('private artifact identity advances independently to web core v1215 and iOS 1.0.340 (340)',()=>{
  assert.match(privateApp,/const APP_VER='v1215 · 私人外卖搜索修复版'/);
