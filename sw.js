const BUILD='1247';
const HOTFIX='v1247-offline-reply-length-1';
const SHELL_CACHE='north-shell-v1247-offline-reply-length-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1247-offline-reply-length-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1247-offline-reply-length-1'")
