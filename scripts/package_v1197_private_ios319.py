...
GUIDE = '第三百一十九次安装_v1197_共同生活模型路线诊断_请先读.md'
NAME = 'SmallPhone_v1197_CohabDiagnostics_iOS319_MacSourceCandidate'
OUTPUT = ROOT.parent / '小手机_v1197_私人版_iOS319_共同生活模型路线诊断_Mac待编译源码包.zip'
...
for token in ["__NORTH_SHELL_BUILD__='1197'",'app.js?v=1197&r=v1197-couple-watch-1','private-runtime-diagnostics.js?v=319','couple-watch.js?v=1197','couple-watch-runtime.js?v=1197','html.north-native-app .phone:has(.offinput)']:
    require(shell, token)
require(shell,'cohab-model-diagnostics.js?v=1197')
require(app,"APP_VER='v1197 · 共同生活模型路线诊断版'")
...
for name in ['cohab-model-diagnostics.js','couple-watch.js','couple-watch-runtime.js','cohab-theater.js','bead-studio.js','heart-quiz.js']:
