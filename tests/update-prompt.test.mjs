...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1253'/);
assert.match(html, /sw\.js\?v=1253&r=v1253-web-two-fixes-1/);
assert.match(html, /web-hotfix\.js\?v=1253&r=v1253-web-two-fixes-1/);
