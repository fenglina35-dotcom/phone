...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1169'/);
assert.match(html, /sw\.js\?v=1169&r=v1169-heartquiz-progressive-fill-1/);
assert.match(html, /web-hotfix\.js\?v=1169&r=v1169-heartquiz-progressive-fill-1/);
