...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1140'/);
assert.match(html, /sw\.js\?v=1140&r=v1140-web-smart-home-relay-1/);
assert.match(html, /web-hotfix\.js\?v=1140&r=v1140-web-smart-home-relay-1/);
