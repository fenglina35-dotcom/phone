const BUILD='1193';
const HOTFIX='v1193-couple-watch-trigger-1';
const SHELL_CACHE='north-shell-v1193-couple-watch-trigger-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1193-couple-watch-trigger-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1193-couple-watch-trigger-1'")
