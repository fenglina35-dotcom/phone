...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1155'/);
assert.match(html, /sw\.js\?v=1155&r=v1155-role-moment-image-permission-1/);
assert.match(html, /web-hotfix\.js\?v=1155&r=v1155-role-moment-image-permission-1/);
