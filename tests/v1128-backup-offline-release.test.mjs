...
test('v1178 has a unique visible identity across every public entry and cache layer',()=>{
  ...
  assert.match(worker,/const BUILD='1282'/);
  assert.match(worker,/north-shell-v1282-app-decision-visibility-1/);
  assert.match(hotfix,/sw\.js\?v=1282&r=v1282-app-decision-visibility-1/);
