const BUILD='1140';
const HOTFIX='v1140-web-smart-home-relay-hotfix-1';
const SHELL_CACHE='north-shell-v1140-web-smart-home-relay-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1140-web-smart-home-relay-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1140-web-smart-home-relay-1'")
