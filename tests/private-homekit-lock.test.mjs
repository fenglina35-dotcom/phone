...
test('private release identity is iOS 362 while public web stays v1253',()=>{
  ...
  assert.match(project,/CURRENT_PROJECT_VERSION = 362/);
  assert.match(project,/MARKETING_VERSION = 1.0.362/);
  assert.match(read('app.js'),/__NORTH_SHELL_BUILD__!==\'1253\'/);
});
