"""Create the private v1325 / iOS 396 Mac-source overlay package.
...
PREFIX = "SmallPhone_v1325_iOS396_Private/"
OUTPUT = ROOT.parent / "SmallPhone_v1325_iOS396_MacSource.zip"
...
def main() -> None:
    ...
    with TemporaryDirectory(prefix="private1325-verify-") as folder:
        with ZipFile(OUTPUT) as archive:
