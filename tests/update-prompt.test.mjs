...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1209'/);
assert.match(html, /sw\.js\?v=1209&r=v1209-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1209&r=v1209-couple-watch-trigger-1/);
