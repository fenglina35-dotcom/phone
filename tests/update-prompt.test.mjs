...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1199'/);
assert.match(html, /sw\.js\?v=1199&r=v1199-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1199&r=v1199-couple-watch-trigger-1/);
