...
test('private release identity is iOS 387 while public web advances independently',()=>{
  ...
  assert.match(project,/CURRENT_PROJECT_VERSION = 387/);
  assert.match(project,/MARKETING_VERSION = 1.0.387/);
  assert.match(read('app.js'),/__NORTH_SHELL_BUILD__!==\'1306\'/);
});
