...
test('v1033 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1033/);
  assert.match(html,/sw\.js\?v=1033&r=v1033-wechat-contacts-1/);
});
