const BUILD='1180';
const HOTFIX='v1180-summary-call-offline-1';
const SHELL_CACHE='north-shell-v1180-summary-call-offline-1';
...
const CORE_FILES=[
  ...
  {url:'./cohab-theater.js?v='+BUILD+'&r=v1180-summary-call-offline-1',kind:'theater'},
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1180-summary-call-offline-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='theater')return text.length>30000
    &&text.includes("window.__NORTH_COHAB_THEATER__='v1180-summary-call-offline-1'")
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1180-summary-call-offline-1'")
