...
test('private iOS 333 overlay owns the disable marker and cancels automatic scheduling', async () => {
...
test('native recovery UI stays outside WebKit and carries the private 333 identity', () => {
