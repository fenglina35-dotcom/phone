...
test('private v1178 loads diagnostic parity between app core and theater extension',()=>{
  for(const file of ['index.html','小手机.html']){
    ...
    assert.match(html,/app\.js\?v=1246[^\n]*<\/script>\s*<script src="private-reply-intercept\.js\?v=1246&r=v1178-private-intercept-parity-1"[^\n]*<\/script>\s*<script src="cohab-theater\.js\?v=1246/);
  }
