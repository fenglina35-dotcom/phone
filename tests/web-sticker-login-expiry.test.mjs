...
test('the web shell and service worker require the hotfix while private files stay outside its entry path',()=>{
  assert.match(shell,/web-hotfix\.js\?v=1127&r=v1127-social-studio-worldbook-1/);
  assert.match(hotfix,/sw\.js\?v=1127&r=v1127-social-studio-worldbook-1/);
  assert.match(worker,/kind:'hotfix'/);
  assert.match(worker,/north-shell-v1127-social-studio-worldbook-1/);
