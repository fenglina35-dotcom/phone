...
test('v1184 web files use one cache-busting build number',()=>{
  ...
  assert.match(app,/const url='sw\.js\?v=1236&r=v1236-backup-auto-download-1'/);
  assert.match(html,/__NORTH_SHELL_BUILD__='1236'/);
  assert.match(html,/app\.js\?v=1236/);
  assert.match(sw,/const BUILD='1236'/);
  assert.match(sw,/north-shell-v1236-backup-auto-download-1/);
