...
DELIVERY = ROOT / "delivery-v1033"
PACKAGE_NAME = "SmallPhone_v1033_WeChatContacts_iOS154_MacReady"
STAGING = DELIVERY / PACKAGE_NAME
ZIP_PATH = DELIVERY / f"{PACKAGE_NAME}.zip"
INSTALL_GUIDE = "第一百五十四次安装_v1033_微信通讯录与角色管理升级_请先读.md"
...
if DELIVERY.exists():
    ...
    if resolved.parent != ROOT.resolve() or resolved.name != "delivery-v1033":
...
if "APP_VER='v1033 · 微信通讯录与角色管理升级';" not in app_text:
    raise RuntimeError("bundled web version is not v1033")
