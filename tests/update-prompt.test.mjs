...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1202'/);
assert.match(html, /sw\.js\?v=1202&r=v1202-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1202&r=v1202-couple-watch-trigger-1/);
