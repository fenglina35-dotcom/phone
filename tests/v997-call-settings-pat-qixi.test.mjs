...
test('v1035 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1035/);
  assert.match(html,/sw\.js\?v=1035&r=v1035-wechat-discover-1/);
});
