...
DELIVERY = ROOT / "delivery-v1035"
PACKAGE_NAME = "SmallPhone_v1035_WeChatDiscover_iOS154_MacReady"
STAGING = DELIVERY / PACKAGE_NAME
ZIP_PATH = DELIVERY / f"{PACKAGE_NAME}.zip"
INSTALL_GUIDE = "第一百五十五次安装_v1035_微信发现页与附近好友_请先读.md"
...
if DELIVERY.exists():
    ...
    if resolved.parent != ROOT.resolve() or resolved.name != "delivery-v1035":
...
if "APP_VER='v1035 · 微信发现页与附近好友';" not in app_text:
    raise RuntimeError("bundled web version is not v1035")
