...
test('v1017 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1017/);
  assert.match(html,/sw\.js\?v=1017&r=v1017-notebook-inbox-bubble-repair-1/);
});
