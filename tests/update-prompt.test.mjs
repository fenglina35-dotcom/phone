...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1316'/);
assert.match(html, /sw\.js\?v=1316&r=v1316-web-imsg-1/);
assert.match(html, /web-hotfix\.js\?v=1316&r=v1316-web-imsg-1/);
