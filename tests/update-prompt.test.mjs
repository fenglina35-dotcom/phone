...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1192'/);
assert.match(html, /sw\.js\?v=1192&r=v1192-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1192&r=v1192-couple-watch-trigger-1/);
