...
test('v1178 has a unique visible identity across every public entry and cache layer',()=>{
  ...
  assert.match(worker,/const BUILD='1194'/);
  assert.match(worker,/north-shell-v1194-couple-watch-trigger-1/);
  assert.match(hotfix,/sw\.js\?v=1194&r=v1194-couple-watch-trigger-1/);
