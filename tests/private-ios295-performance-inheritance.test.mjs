...
test('private identifiers remain v1291 and iOS 380 while public advances independently', () => {
  assert.equal(index, alias);
  assert.match(index, /window\.__NORTH_SHELL_BUILD__='1291'/);
  assert.match(index, /app\.js\?v=1291&r=v1291-private-dy-cover-1/);
  ...
  assert.match(publicEntry, /window\.__NORTH_SHELL_BUILD__='1290'/);
...
test('Mac guide identifies the current private v1291 iOS380 source', () => {
