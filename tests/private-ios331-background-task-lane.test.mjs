...
test('private performance candidate has a v1247 identity while public web stays v1247', () => {
  assert.equal(privateIndex, privateAlias);
  assert.match(privateIndex, /window\.__NORTH_SHELL_BUILD__='1247'/);
  assert.match(privateIndex, /app\.js\?v=1247&r=v1247-offline-reply-length-1/);
