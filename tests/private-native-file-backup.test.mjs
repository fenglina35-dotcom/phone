...
test('private v1283 loads daily backup after the diagnostic overlay while public advances independently',()=>{
  for(const name of ['index.html','小手机.html']){
    const html=read(bundle+name);
    assert.match(html,/window\.__NORTH_SHELL_BUILD__='1283'/);
    assert.ok(html.indexOf('private-cloud-backup.js?v=1283')>html.indexOf('private-runtime-diagnostics.js?v=339'));
  }
