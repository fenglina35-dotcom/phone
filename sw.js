const BUILD='1179';
const HOTFIX='v1179-format-bead-fix-1';
const SHELL_CACHE='north-shell-v1179-format-bead-fix-1';
...
const CORE_FILES=[
  ...
  {url:'./cohab-theater.js?v='+BUILD+'&r=v1179-format-bead-fix-1',kind:'theater'},
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1179-format-bead-fix-1',kind:'hotfix'},
...
const OPTIONAL_FILES=[
  ...
  './bead-studio.js?v='+BUILD+'&r=v1179-pixel-puzzle-2',
...
function validShellText(kind,text){
  ...
  if(kind==='theater')return text.length>30000
    &&text.includes("window.__NORTH_COHAB_THEATER__='v1179-format-bead-fix-1'")
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1179-format-bead-fix-1'")
