...
const PERMANENT_FIXES = [
  { release: "v1322/v1323", scope: "both", least: 1, name: "逐条查手机已读账本", marker: "function rolePhoneLocalRead(" },
  { release: "v1322/v1323", scope: "both", least: 1, name: "送达后才消费查手机记录", marker: "function rolePhoneLocalCommit(" },
  { release: "v1322/v1323", scope: "both", least: 1, name: "角色独立电话几率", marker: "function effCallProb(c)" },
  { release: "v1322/v1323", scope: "both", least: 1, name: "情侣任务默认关闭", marker: "S.couple.tasksEnabled===true" },
  { release: "v1322/v1323", scope: "both", least: 1, name: "真人转账独立回执", marker: "function pfTransferReceiptMessage(" },
  { release: "v1322/v1323", scope: "both", least: 1, name: "磨砂颜色即时同步", marker: "st.style.setProperty('--offc-'+key+'-soft'" },
  { release: "v1322/v1323", scope: "both", least: 1, name: "回复长度默认4096", marker: "maxTokens:x.maxTokens==null?4096:x.maxTokens" },
  {
    release: 'v1282/v1283',
