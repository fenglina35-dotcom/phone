...
function harness(){
  ...
  for(const name of ['offSummaryUserCall','offlinePendingStart','fmtDT','conversationGapExact','roleReplyTimelineRows','roleCrossChannelOn','roleRecentChannelRounds','roleOnlineLiveStateText','initiativeAwayPrompt','recentMealProgressPrompt','rolePhoneAuthoritativeUsageContext','rolePhotoFrequencyContext','roleLatestUserChannel','roleServerPushConversationBoundary','msgs','msgToText','msgClearTime','topSummaries','summaryCleanText','traitDesc','offCurrentInput','offRender','cohabTogetherScene','cohabPhaseLabel','manualReplySceneOn','offNarrationMode','cohabAdvance','cohabSettingsPanel','offStageAttrs','offRevealText','offElapsed','cohabClockText','cohabStatusLabel','cohabSeen','cohabGoWechat','cohabActionTap','openModal','esc','offNarrationDecorate']){
