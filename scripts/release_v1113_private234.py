"""Bump the role app-lock and cohabitation-entry release to v1113 / private iOS 1.0.234."""
...
def update_text(path: Path) -> bool:
    ...
    for old, new in [
        ("v1112", "v1113"),
        ("?v=1112", "?v=1113"),
        ("BUILD='1112'", "BUILD='1113'"),
        ("BUILD__='1112'", "BUILD__='1113'"),
        ("BUILD__!=='1112'", "BUILD__!=='1113'"),
        ("<string>1112</string>", "<string>1113</string>"),
        ("north-shell-v1112", "north-shell-v1113"),
        ("north-sw-reloaded-1112", "north-sw-reloaded-1113"),
        ("v1113 · 个人外卖电脑隔离试用版", "v1113 · 角色软件锁定与共同生活入口版"),
        ("v1113-personal-delivery-device-1", "v1113-role-app-lock-cohab-entry-1"),
        ("1.0.233 (233)", "1.0.234 (234)"),
        ("1.0.233（233）", "1.0.234（234）"),
        (r"1\.0\.233 \(233\)", r"1\.0\.234 \(234\)"),
        ("1.0.233", "1.0.234"),
        (r"1\.0\.233", r"1\.0\.234"),
        ("CURRENT_PROJECT_VERSION = 233;", "CURRENT_PROJECT_VERSION = 234;"),
        ("CURRENT_PROJECT_VERSION = 233", "CURRENT_PROJECT_VERSION = 234"),
        ("MARKETING_VERSION = 1.0.233;", "MARKETING_VERSION = 1.0.234;"),
    ]:
