...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1167'/);
assert.match(html, /sw\.js\?v=1167&r=v1167-heart-cohab-x-memory-1/);
assert.match(html, /web-hotfix\.js\?v=1167&r=v1167-heart-cohab-x-memory-1/);
