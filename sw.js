const BUILD='1148';
const HOTFIX='v1148-android-startup-route-hotfix-1';
const SHELL_CACHE='north-shell-v1148-android-startup-route-1';
...
const CORE_FILES=[
  ...
  {url:'./web-hotfix.js?v='+BUILD+'&r=v1148-android-startup-route-1',kind:'hotfix'},
...
function validShellText(kind,text){
  ...
  if(kind==='hotfix')return text.length>800
    &&text.includes("window.__NORTH_WEB_HOTFIX__='v1148-android-startup-route-1'")
