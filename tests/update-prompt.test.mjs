...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1314'/);
assert.match(html, /sw\.js\?v=1314&r=v1314-web-imsg-1/);
assert.match(html, /web-hotfix\.js\?v=1314&r=v1314-web-imsg-1/);
