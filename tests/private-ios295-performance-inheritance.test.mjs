...
test('private identifiers remain v1295 and iOS 381 while public advances independently', () => {
  ...
  assert.equal((pbx.match(/CURRENT_PROJECT_VERSION = 381;/g) || []).length, 12);
  assert.equal((pbx.match(/MARKETING_VERSION = 1\.0\.381;/g) || []).length, 12);
...
test('Mac guide identifies the current private v1295 iOS381 source', () => {
