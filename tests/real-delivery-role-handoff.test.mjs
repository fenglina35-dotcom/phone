...
assert.match(app,/structuredModelAction:true,accountId:/,'chat and call model parsers must attach current-turn authorization metadata');
assert.match(delivery,/普通聊天中的“饿了、没吃饭、想吃东西”等词本身永远不能直接启动浏览器/,'ordinary chat keywords must not directly trigger an order');
