...
test('v1026 removes synchronous camera JPEG work and preserves the camera audio session',()=>{
...
test('automatic task failures stay silent and the cache identity is new',()=>{
  ...
  assert.match(html,/north-sw-reloaded-1026/);
  assert.match(html,/sw\.js\?v=1026&r=v1026-passkey-rebind-repair-1/);
});
