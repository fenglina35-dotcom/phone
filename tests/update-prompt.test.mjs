...
assert.match(html, /window\.__NORTH_SHELL_BUILD__='1203'/);
assert.match(html, /sw\.js\?v=1203&r=v1203-couple-watch-trigger-1/);
assert.match(html, /web-hotfix\.js\?v=1203&r=v1203-couple-watch-trigger-1/);
